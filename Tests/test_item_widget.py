...
from framework import DBManager, BaseModel, IntEnumField, StrExplainableIntEnum, TableModel
...
def use_PyQt5():
    ...
    table_view.setModel(TableModel(TestTable))
    table_view.model().refresh()
    table_view.show()
    pass
    sys.exit(app.exec_())
